// Design and Develop a Circular queue using sequential representation having max
// size of 50 numbers with operations as insert/delete items to/from it. Write a menu driven C program to perform following operations.
